...
async function main() {
  ...
  try {
    ...
    provider = new ethers.JsonRpcProvider(`https://polygon-mumbai.g.alchemy.com/v2/${process.env.ALCHEMY_MUMBAI_API}`)
  } catch (e) {
    if (e instanceof TypeError) {
      // Try Ethers v5 provider
      console.log("Using Ethers v5 provider format.")
      provider = new ethers.providers.JsonRpcProvider(`https://polygon-mumbai.g.alchemy.com/v2/${process.env.ALCHEMY_MUMBAI_API}`)
    } else {
      console.log(e)
    }
  }
